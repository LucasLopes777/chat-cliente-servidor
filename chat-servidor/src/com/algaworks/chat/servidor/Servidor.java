...
public class Servidor {
	...
	private List<RecebeMensagemCliente> clientes = new ArrayList<RecebeMensagemCliente>();

	public static void main(String[] args) {
		Servidor servidor = new Servidor();
		servidor.aguardaConexoes(servidor);
		
	}

	public void aguardaConexoes(Servidor servidor) {
